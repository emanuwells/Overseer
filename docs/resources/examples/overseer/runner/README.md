...
~/overseer-venv/bin/pip install -e /home/overseer/Dev/Repos/your-organization/Overseer/src
```
...
[`runner-windows/`](../runner-windows/README.md) e os scripts em
`scripts/windows/`. O contrato e a convenção multi-host estão em
[`docs/pipeline-integration.md`](../../../../pipeline-integration.md).
