...
description: Início de trabalho num repositório novo ou existente.
---
...
Mapear estrutura, stack, comandos, riscos e documentação antes de alterações não triviais.

## Objetivo

Início de trabalho num repositório novo ou existente.
