...
description: Operar Git sem destruir alterações do utilizador.
---
...
Verificar estado Git e evitar comandos destrutivos.

## Objetivo

Operar Git sem destruir alterações do utilizador.
